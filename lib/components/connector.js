...
var handleMessage = function(self, session, msg) {
  ...
  var routeStatistic = self.app.get("routeStatistic");
  if(routeStatistic == null)
  {
    routeStatistic={};
    self.app.set("routeStatistic");
  }
  if(routeStatistic[msg.route] == null)
  {
    routeStatistic[msg.route] =0;
  }
  routeStatistic[msg.route]+=1;
  self.app.set("routeStatistic",routeStatistic);
